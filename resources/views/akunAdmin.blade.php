...
<body id="kt_body" class="header-tablet-and-mobile-fixed aside-enabled">
                        ...
                        <div class="menu menu-column menu-rounded fw-bold" id="#kt_aside_menu" data-kt-menu="true">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        <div class="menu-item">
                                            <a class="menu-link" href="/akunAdmin">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">New Akun</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        <div class="menu-item">
                                            <a class="menu-link" href="/informasiCustomer">
                                                <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Dalam Antrian</span>
                                            </a>
                                            <a class="menu-link" href="/informasiCustomer2">
                                                <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Proses Pengerjaan</span>
                                            </a>
                                            <a class="menu-link" href="/informasiCustomer3">
                                                <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Proses qc</span>
                                            </a>
                                            <a class="menu-link" href="/informasiCustomer4">
                                                <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                                </span>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        <div class="menu-item">
                                            <a class="menu-link" href="/laporanCustomer">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="header-brand me-5">
                            ...
                            <a href="#">
                                ...
                                <img alt="Logo" src="{{ asset('assets/mitra-pink.png') }}"
                                    class="h-45px d-block d-md-none" />
                            </a>
                            <!--end::Logo-->
                        </div>
                        <!--end::Brand-->
                        ...
                        <div class="topbar d-flex align-items-stretch">
                            ...
                            <div class="d-flex align-items-center me-2 me-lg-4">
                                <a href="{{ route('logout') }}"
                                    ...
                                    title="Keluar dari Aplikasi">{{ __('Logout') }} </a>
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack flex-wrap">
                            ...
                            <div class="page-title d-flex flex-column me-5 py-2">
                                <!--begin::Title-->
                                {{-- <h1 class="d-flex flex-column text-dark fw-bolder fs-1 mb-0">Mitra</h1> --}}
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
                                    ...
                                    <div class="row g-6 g-xl-9 mb-6 mb-xl-9">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href=""
                                                                ...
                                                                data-bs-target="#modalUbah{{ $item->id }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                                        ...
                                                        <div class="modal-dialog modal-centered modal-lg">
                                                            <div class="modal-content shadow-none">
                                                                <div class="modal-header">
                                                                    <h3 class="modal-title">Ubah Akun Mitra</h3>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <label for="basic-url" class="form-label">Nama<span
                                                                        class="text-danger">*</span></label>
                                                                <div class="input-group mb-5">
                                                                    <input type="text" class="form-control" name="name" value="{{ $item->name }}" >
                                                                </div>

                                                                    <label for="basic-url" class="form-label">Email <span
                                                                            class="text-danger">*</span></label>
                                                                    <div class="input-group mb-5">
                                                                    ...
                                                                    <div class="input-group  mb-5" id="#status">
                                                                            ...
                                                                            <div class="input-group  mb-5">
                                                                                <div
                                                                                    ...
                                                                                    <input class="form-check-input"
                                                                                        ...
                                                                                        value="admin" @if($item->role === "admin") checked @endif />
                                                                            ...
                                                                            <div class="input-group  mb-5">
                                                                                <div
                                                                                    ...
                                                                                    <input class="form-check-input"
                                                                                        type="radio" name="role"
                                                                                        value="customer"  @if($item->role === "customer") checked @endif />
                                                                                    <label class="form-check-label"
                                                                                        for="flexRadioDefault"> customer
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                        ...
                                        <div class="row">
                                            <div
                                                ...
                                                <div class="dataTables_info">Menampilkan 10 dari  data</div>
                                            </div>
                                            <div
                    ...
                    <div class="modal fade" tabindex="-1" id="modalTambah">
                        <div class="modal-dialog modal-centered modal-lg">
                            <div class="modal-content shadow-none">
                                <div class="modal-header">
                                    <h3 class="modal-title">Tambah Akun Mitra</h3>
                                ...
                                <div class="modal-body">
                                    ...
                                    <!--end::Notice-->
                                    <form action="/akunAdmin" method="post">
                                        @csrf
                                    <div class="separator my-10"></div>
                                    <label for="basic-url" class="form-label">Nama <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="sa_tambah"
    ...
    <script>
        $('#status').on('change', function () {
            if ($(this).val() == 'selesai') {
                $('#lainnya').html(`<div class="input-group mb-5">
                                    <input type="text" class="form-control" placeholder="Masukkan Faktor">
                                                </div>`);
            } else {
                $('#lainnya').html('');
            }
