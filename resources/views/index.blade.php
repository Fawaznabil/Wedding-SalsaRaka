...
@section('content')
    ...
    <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800" style="background-color: blanchedalmond;">
            <a href="/createTamu" class="btn btn-primary align-self-center btn-hover-scale me-5" style="font-weight: 600">Tambah</a>
    </div>
