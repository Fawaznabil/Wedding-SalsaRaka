                            ...
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    ...
                                    <div class="row g-0">
                                        <div class="col bg-light-danger px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <a href="/informasiCustomer" class="text-danger  fs-6">Souvenir VIP</a>
                                        </div>
                                        ...
                                        <div class="col bg-light-success px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <a href="/laporanCustomer" class="text-success  fs-6">VIP Sesi I</a>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col bg-light-primary px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <a href="/informasiCustomer" class="text-danger  fs-6">VIP Sesi II</a>
                                        </div>
                                    </div>
                                </div><br>
                                ...
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body" id="searchInput">
                                         <form action="/informasiCustomer2" method="GET">
