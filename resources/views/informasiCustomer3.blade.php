                        ...
                        <div id="kt_content_container" class="container-xxl">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col bg-light-success px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <a href="/laporanCustomer" class="text-success  fs-6">VVIP Sesi I</a>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col bg-light-primary px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <a href="/informasiCustomer" class="text-danger  fs-6">VVIP Sesi II</a>
                                        </div>
                                    </div>
                                </div><br>
                                <div class="card shadow-sm">
                            ...
                            <div class="card mb-5 mb-xl-10 shadow-sm" id="kt_profile_details_view">
                                ...
                                <div class="card-header cursor-pointer">
                                    <!--begin::Card title-->
                                    <div class="card-title m-0">
                                        <h3 class="fw-bolder m-0">Informasi Souvenir VVIP</h3>
                                    </div>
                                </div>
