...
<table>
<td style="vertical-align: baseline;">PN{{$item->id}}</td>
<td style="vertical-align: middle;">{{$item->NAMA_PEMESANAN }}</td>
<td style="vertical-align: bottom;">{{$item->ASAL_INSTANSI}}</td>
